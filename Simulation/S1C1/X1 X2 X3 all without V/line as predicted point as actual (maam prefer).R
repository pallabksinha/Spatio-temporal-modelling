...
#         title = 'Regions', 
#         tickvals = c(1, 2, 3), 
#         ticktext = c('Region-1', 'Region-2', 'Region-3'), 
#         showgrid = FALSE
#       ),
#       zaxis = list(
#         title = 'Disease Count',
#         range = c(0, 1500),
#         showgrid = FALSE,
#         tickvals = seq(200, 1400, by = 200)  # exclude 0
#       )
#     ),
#     legend = list(
#       x = 0.6, y = 0.9,
...
plot_ly(colors = c("red", "blue", "green")) %>%
  ...
  layout(
    scene = list(
      xaxis = list(title = 'Time (in biweeks)', showgrid = FALSE,titlefont = list(size = 17)),
      yaxis = list(
        title = 'Regions',
        tickvals = c(1, 2, 3),
        ticktext = c('Region-1', 'Region-2', 'Region-3'),
      ...
      zaxis = list(
        ...
        titlefont = list(size = 17)# exclude 0
      )
    ),showlegend = FALSE,
