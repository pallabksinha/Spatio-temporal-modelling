...
plot_ly() %>%
  ...
  add_trace(
    ...
    marker = list(
      ...
      symbol = 'star'  # Use star shape
    )
  )%>%
  
  # Overlay "predicted2" on Region-2
  add_trace(
    x = time, 
    ...
    mode = 'markers',  
    marker = list(
      color = 'black',  # Change color for clarity
      size = 2,  
      symbol = 'star'
    )
  ) %>%
  # Overlay "predicted3" on Region-3
  add_trace(
    x = time, 
    y = rep(3, nstep),  # Region-2
    z = predicted3, 
    type = 'scatter3d', 
    mode = 'markers',  
    marker = list(
...
plot_ly() %>%
  add_trace(data = data, 
            ...
            name = ~paste0("Region ", region, " - Actual Count"), # Assign custom names
            line = list(width = 4)) %>%
  add_trace(
    x = time, 
    y = rep(1, nstep),  # Overlay on Region-1
    ...
    type = 'scatter3d', 
    mode = 'markers',
    name = 'Region 1 - Predicted Count',  # Rename trace in legend
    marker = list(
      color = 'black', 
      size = 1,  
      symbol = 'star'  
  ...
  add_trace(
    ...
    type = 'scatter3d', 
    mode = 'markers',  
    name = 'Region 2 - Predicted Count',  # Rename trace in legend
    marker = list(
      color = 'black',  
      size = 2,  
      symbol = 'star'
  ...
  add_trace(
    ...
    type = 'scatter3d', 
    mode = 'markers',  
    name = 'Region 3 - Predicted Count',  # Rename trace in legend
    marker = list(
      color = 'black',  
      size = 2,  
      symbol = 'star'
